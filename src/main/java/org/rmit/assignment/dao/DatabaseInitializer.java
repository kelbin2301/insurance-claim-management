...
public class DatabaseInitializer {
    ...
    private void createSampleDataWhenFirstInit() {
        try {
            ...
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000004', 'Bob ABC', 'dependent', 'c-1000003');");

            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000005', 'Charlie Doe', 'policy_holder', NULL);");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000006', 'David Doe', 'dependent', 'c-1000005');");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000007', 'Eve Doe', 'dependent', 'c-1000005');");

            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000008', 'Frank Smith', 'policy_holder', NULL);");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000009', 'Grace Smith', 'dependent', 'c-1000008');");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000010', 'Henry Smith', 'dependent', 'c-1000008');");

            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000011', 'Ivy White', 'policy_holder', NULL);");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000012', 'Jack White', 'dependent', 'c-1000011');");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000013', 'Kate White', 'dependent', 'c-1000011');");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000014', 'Liam White', 'dependent', 'c-1000011');");

            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000015', 'Mia Black', 'policy_holder', NULL);");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of)" +
                    " VALUES ('c-1000016', 'Noah Black', 'dependent', 'c-1000015');");
            statement.execute("INSERT INTO customer (id, full_name, customer_type, dependent_of) " +
                    "VALUES ('c-1000017', 'Olivia Black', 'dependent', 'c-1000015');");
            // ========================
            ...
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000001', 'c-1000001', '2021-10-01', 'f-3000000001_211000001_document1.pdf', 1000.0, 'done', 'b-1000001');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000002', 'c-1000001', '2022-10-01', 'f-3000000002_211000001_document2.pdf', 10000.0, 'done', 'b-1000001');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000003', 'c-1000001', '2023-10-01', 'f-3000000003_211000001_document3.pdf', 100000.0, 'processing', 'b-1000001');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000004', 'c-1000002', '2021-10-01', 'f-3000000004_211000002_document1.pdf', 2000.0, 'done', 'b-1000002');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000005', 'c-1000002', '2023-10-01', 'f-3000000005_211000002_document2.pdf', 20000.0, 'processing', 'b-1000002');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000006', 'c-1000003', '2021-10-01', 'f-3000000006_211000003_document1.pdf', 3000.0, 'done', 'b-1000003');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000007', 'c-1000002', '2023-10-01', 'f-3000000007_211000003_document2.pdf', 30000.0, 'new', 'b-1000003');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000008', 'c-1000004', '2021-10-01', 'f-3000000008_211000004_document1.pdf', 4000.0, 'done', 'b-1000004');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000009', 'c-1000005', '2021-10-01', 'f-3000000009_211000005_document1.pdf', 5000.0, 'done', 'b-1000005');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000010', 'c-1000006', '2021-10-01', 'f-3000000010_211000006_document1.pdf', 6000.0, 'done', 'b-1000006');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000011', 'c-1000007', '2021-10-01', 'f-3000000011_211000007_document1.pdf', 7000.0, 'done', 'b-1000007');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000012', 'c-1000008', '2021-10-01', 'f-3000000012_211000008_document1.pdf', 8000.0, 'done', 'b-1000008');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000013', 'c-1000008', '2023-10-01', 'f-3000000013_211000008_document2.pdf', 80000.0, 'processing', 'b-1000009');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000014', 'c-1000008', '2024-10-01', 'f-3000000014_211000008_document3.pdf', 800000.0, 'new', 'b-1000010');");

            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000015', 'c-1000009', '2021-10-01', 'f-3000000015_211000009_document1.pdf', 9000.0, 'done', 'b-1000009');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000016', 'c-1000009', '2023-10-01', 'f-3000000016_211000009_document2.pdf', 90000.0, 'processing', 'b-1000009');");
            statement.execute("INSERT INTO claim (id, customer_id, exam_date, list_of_documents, claim_amount, status, receiver_bank_id) " +
                    "VALUES ('f-3000000017', 'c-1000009', '2024-10-01', 'f-3000000017_211000009_document3.pdf', 900000.0, 'new', 'b-1000009');");
